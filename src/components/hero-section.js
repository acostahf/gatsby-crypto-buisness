...
export default function heroSection ({children}) {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
      ...
      <button className=" bg-white backdrop-filter backdrop-blur-xl bg-opacity-30 rounded text-blue-300 text-md px-2 py-1 flex   ">Read Docs<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
